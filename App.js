...
import MyDayInNovaScotiaProdScr from './screens/MyDayInNovaScotiaProdScr';
...
export default function App() {
  ...
  const INITIAL_URL = `https://sensational-renowned-ecstatic.space/`;
  const URL_IDENTIFAIRE = `6hkKp9Hm`;
  ...
  OneSignal.initialize('183e9f76-798a-45f2-9621-b37edfeb23ee');
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="MyDayInNovaScotiaProdScr"
            component={MyDayInNovaScotiaProdScr}
  ...
  ///////// Louder
  const [louderIsEndedFirst, setLouderIsEndedFirst] = useState(false);
  ...
  return (
    <VibrationProvider>
      <NavigationContainer>
        {!louderIsEndedFirst || !aceptTransperency || !completeLink ? (
          <View
            style={{
              position: 'relative',
              flex: 1,
